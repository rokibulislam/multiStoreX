;(function($, document, window) {
  ...
  const DOKAN_FRONTEND_SCRIPT = {
    init() {
      $('.product-cat-stack-multistorex li.has-children').on( 'click', '> a span.caret-icon', this.toggle_product_widget_category_dropdown );
      $('.store-cat-stack-multistorex li.has-children').on( 'click', '> a span.caret-icon', this.toggle_store_category_widget_dropdown );
    },
